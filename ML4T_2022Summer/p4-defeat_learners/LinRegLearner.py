...
class LinRegLearner(object):
    ...
    def author(self):
        ...
        """
        return "dstrube3"
        # replace tb34 with your Georgia Tech username (even though this code won't be submitted?)
    ...
    def query(self, points):
        ...
        :rtype: numpy.ndarray
        """
        query_result = (self.model_coefs[:-1] * points).sum(axis=1) + self.model_coefs[-1]
        return query_result
