...
class RTLearner(object):
    # From P3
    """
    This is a Random Tree Learner. Contains the code for the classification Random Tree class
    ...
    def __init__(self, leaf_size=0, verbose=False):
        ...
        # For P8, minimum leaf size is 5
        if leaf_size < 5:
            leaf_size = 5
            if verbose:
                print('Naw, leaf_size is too small. Setting it to 5.')
