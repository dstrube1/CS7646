...
def compute_portvals(orders, start_val=100_000.0, commission=9.95, impact=0.005):
    """
    ...
    allocations = find_allocations(buying_table)
    daily_portfolio_values = compute_daily_portfolio_values(buying_table, allocations)
