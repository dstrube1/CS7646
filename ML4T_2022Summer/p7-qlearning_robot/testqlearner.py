...
def sub_test_code(filename):
    ...
    non_dyna_end = time.time()
    non_dyna_total = non_dyna_end - non_dyna_start
    ...
    dyna_end = time.time()
    dyna_total = dyna_end - dyna_start

    print(f"results for {filename}")
    print(f"non_dyna_score: {non_dyna_score}", end='')
    print(" in {0:.3f} seconds".format(non_dyna_total))
    print(f"dyna_score    : {dyna_score}", end='')
    print(" in {0:.3f} seconds".format(dyna_total))
...
def test_code():
    ...
    for in_file in dir_list:
        filename = dir_path + in_file
        # if "1" in filename:
        # if "3" in filename or "4" in filename or "10" in filename:
        sub_test_code(filename)
        print()
