...
def compute_daily_returns(df):
    ...
    # Note: above, we say df[:-1].values and not just df[:-1] because when given two data frames,
    # Pandas will try to match each row based on index when performing elementwise arithmetic operations
